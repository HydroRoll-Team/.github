...
+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
| `lib.rules.coc`_                                               | |Todo|         | HsiangNianian , `Skyfall`_                    | 水系内置coc规则包             | ``Python`` ``TypeScript`` ``Flask``                 |
+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
| `logshader`_                                                   | |In Progress1| | HsiangNianian , `白咕咕`_                     | 水系log着色器                 | ``Python`` ``TypeScript`` ``Vuetify`` ``Vue``       |
+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
| `deadlines`_                                                   | |In Progress1| | HsiangNianian                                 | 水系各类事件倒计时            | ``Python`` ``Jykell``                               |
+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
| `infini`_                                                      | |In Progress9| | HsiangNianian, 白咕咕, `苏向夜`_              | 轻量的文本输入输出流框架       | ``Python`` ``TypeScript`` ``Flask`` ``nextjs``      |
+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
...
.. HyroRollCore: https://github.com/HydroRoll-Team/HydroRollCore
