...
+ Standards    +----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
|  with        | `infini`_                                                      | |Todo|         | HsiangNianian , `苏向夜`_                     | 轻量的文本输入输出流框架      | ``Python`` ``TypeScript`` ``Flask``                 |
+ Distribution +----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
|              | `ipm`_                                                         | |In Progress1| | 苏向夜                                        | infini 包管理器               | ``Python`` ``TypeScript`` ``Vuetify`` ``Vue``       |
+              +----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
|              | `ipm-server`_                                                  | |In Progress1| | HsiangNianian                                 | ipm 官方镜像服务器            | ``Python`` ``TypeScript`` ``Vuetify`` ``Vue``       |
+--------------+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
| Downstream   | `deadlines`_                                                   | |In Progress1| | HsiangNianian                                 | 水系各类事件倒计时            | ``Python`` ``Jykell``                               |
+  ecology     +----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
|              | `HydroRoll`_                                                   | |In Progress2| | HsiangNianian                                 | 基于iamai的骰系插件           | ``Rust`` ``Python`` ``Vue`` ``Pyo3`` ``Cpython``    |
+ example      +----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
|  reference   | `nivis`_                                                       | |In Progress2| | HsiangNianian                                 | 水系窗口CLI语言, reply加载器  | ``Python`` ``Rust`` ``Sphinx`` ``Pyo3``             |
+--------------+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
| :Others:     | `OneRoll`_                                                     | |In Progress3| | HsiangNianian                                 | 骰点表达式解析库              | ``Python`` ``Cpp`` ``AST``                          |
+   resource   +----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
|              | `lib.rules.thepool`_ [#]_                                      | |In Progress8| | HsiangNianian , `James V. West`_              |  水系内置规则包               |  ``Python`` ``LaTeX`` ``aiohttp``                   |
+--------------+----------------------------------------------------------------+----------------+-----------------------------------------------+-------------------------------+-----------------------------------------------------+
...
.. _lib.rules.thepool: https://github.com/HydroRoll-Team/HydroRoll-Core/tree/main/lib/rules/The%20Pool
